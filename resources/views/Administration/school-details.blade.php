...
@section('content')
    ...
    <div class="container">
        ...
        <ul class="text-center"
            style="display: flex;justify-content: center;align-items: center;flex-direction: column;list-style-type: none">
            ...
            <table class="table table table-striped table-hover all-schools">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-primary show-btn" data-bs-toggle="modal"
                ...
                @foreach ($specializations as $specialization)
                    <tr>
                        ...
                        <td>{{ $specialization->schools->first() ? $specialization->schools->first()->pivot->teachers_num : 0 }}
                        </td>
                    </tr>
                @endforeach
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <form action="{{ route('admin.school.change', $school->id) }}" method="POST">
                @csrf
                <button type="submit" class="btn table-submit2 table-submit3">{{ !$school->status ? 'فتح' : 'إغلاق' }}
                    المدرسة</button>
            </form>
    ...
    <div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.school.trasfer', $school->id) }}" method="POST"
                        class="all-schools-form1">
                        @csrf
